...

{
  ...
  class Product {
    ...
    initAccordion() {
      ...
      thisProduct.accordionTrigger.addEventListener('click', function (event) {
        ...
        for (let activeProduct of allProducts) {
          /* if product is not the same as thisProduct, remove active class */
    ...
    processOrder() {
      ...
      for (let paramId in thisProduct.data.params) {
        ...
        for (let optionId in param.options) {
          ...
          // find image for pair paramId-optionId
    ...
    prepareCartProduct() {
      ...
      //console.log(productSummary.price);
  ...
  class Cart {
    ...
    remove(cartProduct) {
      ...
      // Delete represent product from HTML
